...
namespace Repositories.EFCore.Extensions
{
    public static class BookRepositoryExtensions
    {
        public static IQueryable<Book> FilterBooks(this IQueryable<Book> books,
            DateTime minDateTime, DateTime maxDateTime, int CategoryId = -1) =>
            books = books.Where(book =>
                book.DateTime >= minDateTime &&
                book.DateTime <= maxDateTime &&
                (CategoryId != -1 ?
            ...
            string searchTerm)
        {
            ...
            var lowerCaseTerm = searchTerm.Trim().ToLower(); // "aRama MeTinleri" dönüşüm "arama metinleri" (tümüyle küçültür)
            return books
                .Where(b => b.Text
                .ToLower()
                .Contains(searchTerm));
