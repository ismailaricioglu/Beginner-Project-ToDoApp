...
namespace WebApi.Extensions
{
    public static class ServicesExtensions
    {
        ...
        public static void ConfigureHttpCacheHeaders(this IServiceCollection services) =>
            ...
            validastionOp =>
            {
                validastionOp.MustRevalidate = false;
            });

        public static void ConfigureRateLimitingOptions(this IServiceCollection services)
        {
            var rateLimiteRules = new List<RateLimitRule>()
            {
                new RateLimitRule()
                {
                    Endpoint = "*",
            ...
            {
                opt.GeneralRules = rateLimiteRules; ;
            });
            ...
            services.AddSwaggerGen(s =>
            {
                ...
                s.SwaggerDoc("v1",
                    new OpenApiInfo
                    {
                        ...
                        Description = " Beginner ToDoList Project",
                        TermsOfService = new Uri("https://github.com/ismailaricioglu"),
                        Contact = new OpenApiContact
                        {
                            Name = "İsmail Arıcıoğlu",
                            Email = "i_aricioglu@hotmail.com",
